...
type WebSocketHandler func(c *touka.Context, conn *websocket.Conn)
...
type WebSocketUpgradeOptions struct {
	...
	OnError func(c *touka.Context, status int, err error)
}
...
func defaultWebSocketOnError(c *touka.Context, status int, err error) {
...
func WebSocketUpgrade(opts WebSocketUpgradeOptions) touka.HandlerFunc {
	if opts.Handler == nil {
